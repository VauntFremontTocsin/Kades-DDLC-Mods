...
init -100 python:
    ...
    for archive in ['audio','images','scripts','fonts']:
        if not archive in config.archives:
            ...
            renpy.error("Come on... You need the files of ddlc... How would this work... I Have No Idea - Monika")
...
init python:
    ...
    splash_message_default = "The Choices By Kade"
...
image menu_art_s:
    ...
    ycenter 24124
    zoom 0.21412
    menu_art_move(0.9999, 241, 0.84523)
